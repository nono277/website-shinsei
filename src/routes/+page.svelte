	...
	<div style="max-width:72rem;margin:0 auto;">
		...
		<div style="display:grid;grid-template-columns:repeat(1,1fr);gap:1.5rem;max-width:1000px;margin:0 auto;" class="sm:grid-cols-2 lg:grid-cols-3">
			{#each [
				...
				{ username: 'MrRat45',   role: 'Co-fondateur · Discord & Partenariat',      color: '#7c3aed', badge: 'CO-FOUNDER', desc: "Co-fondateur de SHINSEI et responsable de la communauté Discord et des partenariats. Gestion des relations avec Breath of Legends et les serveurs partenaires." },
